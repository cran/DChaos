...
#   gauss.sim      Simulates time series from the Gauss map
################################################################################
...
#' @param alpha a non-negative integer denoting the value of parameter \code{alpha} (Default 6.2).
#' @param beta a non-negative integer denoting the value of parameter \code{beta} (Default -0.5).
